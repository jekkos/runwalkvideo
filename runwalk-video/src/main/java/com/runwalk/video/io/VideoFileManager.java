...
public class VideoFileManager {
	...
	private  File getVideoFile(VideoFolderRetrievalStrategy videoFolderRetrievalStrategy, Recording recording) {
		synchronized(recordingStatusMap) {
			...
			LOGGER.debug("Resolved videoFile {} with recordingStatus {}", videoFile.getAbsolutePath(), recordingStatus);
			if (recordingStatus == null)  {
				...
				LOGGER.debug("Add recording {} with status {} to cache", recording.getVideoFileName(), recordingStatus);
